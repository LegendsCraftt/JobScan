...
class QToggle(QCheckBox):
    ...
    def __init__(self, parent=None):
        ...
        self._bg_color              = QColor("#6d94ad")
        self._circle_color          = QColor("#DDD")
        self._active_color          = QColor('#777')
        self._disabled_color        = QColor("#CCC")
        self._text_color            = QColor("#74777a")
    ...
    circle_pos = pyqtProperty(
        ...
        lambda self,
        pos: (setattr(self, '_circle_pos', pos), self.update()))

    intermediate_bg_color = pyqtProperty(
        QColor,
        lambda self: self._intermediate_bg_color,
        lambda self,
        col: setattr(self, '_intermediate_bg_color', col))
